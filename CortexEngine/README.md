...
- public showcase scene, material lab, conductor-energy, vegetation-state, glass/water courtyard, effects showcase, visual baseline, and screenshot negative checks,
