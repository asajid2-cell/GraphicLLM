...
//
// This first slice establishes concrete history resources without changing
// source admission policy. Later slices can sample previous history and add
// source-ID hysteresis on top of this resource contract.
...
PSOutput PSMain(VSOutput input) {
    ...
    output.historyValidity = float4(active, sourceClass, forcedUnavailable, historyRequiredButMissing);
    return output;
}
