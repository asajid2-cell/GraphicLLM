...
struct FrameContract {
    ...
    struct EnvironmentInfo {
        ...
        bool localReflectionCubemapCaptureAllocated = false;
        bool localReflectionCubemapCaptureScheduled = false;
        bool localReflectionCubemapCaptureExecuted = false;
        bool localReflectionCubemapCaptureFailed = false;
        uint32_t localReflectionCubemapCaptureFaceSize = 0;
        uint32_t localReflectionCubemapCaptureFaceCount = 0;
        uint32_t localReflectionCubemapCaptureScheduledProbes = 0;
        uint32_t localReflectionCubemapCaptureCapturedFaces = 0;
        float localReflectionCubemapCaptureCenterX = 0.0f;
        float localReflectionCubemapCaptureCenterY = 0.0f;
        float localReflectionCubemapCaptureCenterZ = 0.0f;
        std::string localReflectionCubemapCaptureMode = "none";
        std::string localReflectionCubemapCaptureFailureReason;
