...
json FullSceneShaderPipelineV2ToJson(const FrameContract& contract) {
    ...
    return {
        ...
        {"material", {
            {"enabled", context.materialModelEvidence.enabled},
            {"full_scene_material_model_ready",
             context.materialModelEvidence.fullSceneMaterialModelReady},
            {"runtime_policy_bridge_ready",
             context.materialModelEvidence.runtimePolicyBridgeReady},
            {"family_counts_available", context.materialModelEvidence.familyCountsAvailable},
            {"reflection_policies_available",
             context.materialModelEvidence.reflectionPoliciesAvailable},
            {"temporal_policies_available",
             context.materialModelEvidence.temporalPoliciesAvailable},
            {"post_policies_available", context.materialModelEvidence.postPoliciesAvailable},
            {"texture_evidence_available",
             context.materialModelEvidence.textureEvidenceAvailable},
            {"shader_feature_flags_available",
             context.materialModelEvidence.shaderFeatureFlagsAvailable},
            {"sampled_material_count", context.materialModelEvidence.sampledMaterialCount},
            {"policy_applied_count", context.materialModelEvidence.policyAppliedCount},
            {"missing_hero_texture_evidence_count",
             context.materialModelEvidence.missingHeroTextureEvidenceCount},
            {"descriptor_missing_count", context.materialModelEvidence.descriptorMissingCount},
            {"descriptor_refresh_failure_count",
             context.materialModelEvidence.descriptorRefreshFailureCount},
            {"unknown_material_family_count",
             context.materialModelEvidence.unknownMaterialFamilyCount},
            {"validation_error_count", context.materialModelEvidence.validationErrorCount},
            {"evidence", domainEvidence(context.material)}
        }},
        {"gbuffer", {
            {"enabled", context.gbufferEvidence.enabled},
            {"channel_inventory_available",
             context.gbufferEvidence.channelInventoryAvailable},
            {"albedo_channel_ready", context.gbufferEvidence.albedoChannelReady},
            {"normal_roughness_channel_ready",
             context.gbufferEvidence.normalRoughnessChannelReady},
            {"emissive_metallic_channel_ready",
             context.gbufferEvidence.emissiveMetallicChannelReady},
            {"extended_material_channels_ready",
             context.gbufferEvidence.extendedMaterialChannelsReady},
            {"semantic_material_policy_channel_ready",
             context.gbufferEvidence.semanticMaterialPolicyChannelReady},
            {"object_id_channel_ready", context.gbufferEvidence.objectIdChannelReady},
            {"material_id_channel_ready", context.gbufferEvidence.materialIdChannelReady},
            {"material_policy_channel_ready", context.materialPolicyChannelReady},
            {"velocity_channel_ready", context.gbufferEvidence.velocityChannelReady},
            {"producer_ownership_available",
             context.gbufferEvidence.producerOwnershipAvailable},
            {"debug_view_source_report_available",
             context.gbufferEvidence.debugViewSourceReportAvailable},
            {"missing_required_channel_count",
             context.gbufferEvidence.missingRequiredChannelCount},
            {"missing_ownership_channel_count",
             context.gbufferEvidence.missingOwnershipChannelCount},
...
json FrameContractToJson(const FrameContract& contract) {
    ...
    json result = {
        ...
        {"particles", {
            ...
            {"simulation_backend", contract.particles.simulationBackend},
            {"render_backend", contract.particles.renderBackend},
            ...
            {"soft_depth_fade", contract.particles.softDepthFade},
            {"wind_influence", contract.particles.windInfluence},
            {"effect_preset", contract.particles.effectPreset},
            {"preset_matched_emitters", contract.particles.presetMatchedEmitters},
            {"preset_mismatched_emitters", contract.particles.presetMismatchedEmitters},
        ...
        {"cinematic_post", {
            ...
            {"budget_tracked", contract.cinematicPost.budgetTracked},
            {"estimated_write_mb", contract.cinematicPost.estimatedWriteMB},
            {"full_screen_passes", contract.cinematicPost.fullScreenPasses},
            {"active_effect_count", contract.cinematicPost.activeEffectCount},
            {"motion_blur_budgeted", contract.cinematicPost.motionBlurBudgeted},
            {"depth_of_field_budgeted", contract.cinematicPost.depthOfFieldBudgeted},
            {"vignette_budgeted", contract.cinematicPost.vignetteBudgeted},
            {"lens_dirt_budgeted", contract.cinematicPost.lensDirtBudgeted},
            {"resolution_class", contract.cinematicPost.resolutionClass},
