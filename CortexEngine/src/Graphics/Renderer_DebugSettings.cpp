...
namespace {
constexpr uint32_t kMaxDebugViewMode = 74u;
}
...
void Renderer::CycleDebugViewMode() {
    ...
    // 54 = VB deferred direct light before shadows
    ...
    // 68-73 = FullSceneReflectionV3 resolver outputs.
    // 74 = FullSceneReflectionV3 RT source signal.
    ...
    switch (m_debugViewState.mode) {
        ...
        case 54: label = "VB_DeferredDirectLightUnshadowed"; break;
        ...
        case 68: label = "FullSceneReflectionV3Radiance"; break;
        case 69: label = "FullSceneReflectionV3Confidence"; break;
        ...
        case 74: label = "FullSceneReflectionV3RTSourceSignal"; break;
