...
Renderer::FeatureState Renderer::GetFeatureState() const {
    ...
    state.particlesEnabled = m_particles.State().controls.enabledForScene;
    state.particleDensityScale = m_particles.State().controls.densityScale;
    state.particleQualityScale = m_particles.State().controls.qualityScale;
    state.particleBloomContribution = m_particles.State().controls.bloomContribution;
    state.particleSoftDepthFade = m_particles.State().controls.softDepthFade;
    state.particleWindInfluence = m_particles.State().controls.windInfluence;
    state.particleEffectPreset = m_particles.State().controls.effectPreset;
