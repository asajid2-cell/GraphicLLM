...
Renderer::FeatureState Renderer::GetFeatureState() const {
    ...
    state.particleQualityScale = m_particleState.controls.qualityScale;
    state.particleBloomContribution = m_particleState.controls.bloomContribution;
    state.particleSoftDepthFade = m_particleState.controls.softDepthFade;
    state.particleWindInfluence = m_particleState.controls.windInfluence;
    state.particleEffectPreset = m_particleState.controls.effectPreset;
