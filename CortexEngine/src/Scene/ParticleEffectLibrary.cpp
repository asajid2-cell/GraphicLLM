    ...
    static const std::vector<ParticleEffectDescriptor> descriptors = {
        ...
        },
        {
            ...
            MakeEmitter(ParticleEmitterType::Dust,
                        ...
                        glm::vec3(0.62f, 0.20f, 0.62f),
                        0.022f,
                        0.058f,
                        glm::vec4(1.45f, 1.18f, 0.70f, 0.20f),
                        glm::vec4(1.08f, 0.86f, 0.50f, 0.018f),
                        -0.04f)
        },
        {
            "sparks",
            ...
            MakeEmitter(ParticleEmitterType::Sparks,
                        38.0f,
                        0.70f,
                        glm::vec3(0.3f, 3.0f, 0.25f),
                        glm::vec3(1.0f, 1.2f, 1.0f),
                        0.014f,
                        0.035f,
                        glm::vec4(6.0f, 3.0f, 0.70f, 1.0f),
        ...
        },
        {
            ...
            MakeEmitter(ParticleEmitterType::Embers,
                        48.0f,
                        3.2f,
                        glm::vec3(0.0f, 0.62f, 0.1f),
                        glm::vec3(0.45f, 0.45f, 0.45f),
                        0.020f,
                        0.070f,
                        glm::vec4(3.8f, 1.05f, 0.25f, 0.78f),
        ...
        },
        {
            ...
            MakeEmitter(ParticleEmitterType::Mist,
                        ...
                        glm::vec3(0.46f, 0.20f, 0.46f),
                        0.18f,
                        0.58f,
                        glm::vec4(0.72f, 0.86f, 1.0f, 0.12f),
        ...
        },
        {
            ...
            MakeEmitter(ParticleEmitterType::Mist,
                        ...
                        0.12f,
                        0.48f,
                        glm::vec4(0.80f, 0.90f, 1.0f, 0.16f),
                        glm::vec4(0.80f, 0.90f, 1.0f, 0.0f),
                        -0.02f)
        },
        {
            "rain",
