...
function Invoke-FullSceneShaderV2Packet {
    $args = @(
        ...
        "-ViewFilter", "beauty,surface_policy,material_family,reflection_policy,temporal_policy,post_sensitivity,material_id,object_id,reflection_owner,shadow_factor,direct_light,ambient_ibl,taa_blend",
        "-NoBuild",
        "-SkipSceneAnalyzers"
    )
