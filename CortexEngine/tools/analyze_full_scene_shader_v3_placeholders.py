    ...
    *,
    ...
    if environment_ready:
        ...
        if not isinstance(environment_domain, dict):
            ...
            if v3.get("scene_local_texture_payload_ready") is True:
                ...
                if v3.get("scene_local_environment_proxy_resource_table_required") is not True:
                    failures.append("payload-ready environment without required proxy resource table")
                if v3.get("scene_local_environment_proxy_resource_table_bindable") is not True:
    ...
    if reflection_ready:
        ...
        if not isinstance(reflection_pass, dict):
            ...
            if "vb_gbuffer_material_ext2" not in reflection_pass.get("reads", []):
                failures.append("FullSceneReflectionV3 pass does not read vb_gbuffer_material_ext2")
            for resource in [
                "reflection_radiance",
                "reflection_confidence",
                "reflection_source_id",
    ...
    return {
        ...
        "candidate_beauty_composite_ready": v3.get("candidate_beauty_composite_ready"),
        "candidate_beauty_cinematic_post_ready": v3.get("candidate_beauty_cinematic_post_ready"),
        "candidate_beauty_ldr_output_ready": v3.get("candidate_beauty_ldr_output_ready"),
        "candidate_beauty_reads_candidate_hdr": v3.get("candidate_beauty_reads_candidate_hdr"),
        "candidate_beauty_legacy_bridge_rejected": v3.get("candidate_beauty_legacy_bridge_rejected"),
        "candidate_beauty_default_beauty_unchanged": v3.get("candidate_beauty_default_beauty_unchanged"),
        ...
        "scene_local_texture_payload_ready": v3.get("scene_local_texture_payload_ready"),
        "scene_local_texture_payload_count": v3.get("scene_local_texture_payload_count"),
        "scene_local_texture_set_id": v3.get("scene_local_texture_set_id"),
