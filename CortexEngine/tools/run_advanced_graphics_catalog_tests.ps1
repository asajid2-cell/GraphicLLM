...
if ($systems.ContainsKey("cinematic_post")) {
    ...
    foreach ($requiredPostFeature in @("bloom_threshold", "soft_knee", "vignette", "lens_dirt", "motion_blur", "depth_of_field", "tone_mapper_presets", "color_grade_presets", "frame_contract_stats")) {
