param(
    ...
    [string]$ViewFilter = "beauty,surface_policy,material_family,reflection_policy,temporal_policy,post_sensitivity,material_id,object_id,reflection_owner,reflection_source_weights,reflection_stability_policy,shadow_factor,direct_light,direct_light_unshadowed,direct_light_shadow_loss,ambient_ibl,taa_blend",
    [int]$SmokeFrames = 140,
    [int]$CaptureFrame = 60,
