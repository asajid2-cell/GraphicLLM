...
$cases = @(
    ...
    @{ id = "rain_glass_pavilion"; title = "Rain Glass Pavilion"; scene = "rain_glass_pavilion"; bookmark = "hero"; environment = "studio"; frames = 170; image = "rain_glass_pavilion_hero.png" },
    @{ id = "rain_glass_pavilion_glass_closeup"; title = "Rain Glass Closeup"; scene = "rain_glass_pavilion"; bookmark = "glass_closeup"; environment = "studio"; frames = 150; image = "rain_glass_pavilion_glass_closeup.png" },
    @{ id = "rain_glass_pavilion_puddle_chrome"; title = "Puddle and Chrome"; scene = "rain_glass_pavilion"; bookmark = "puddle_chrome"; environment = "studio"; frames = 150; image = "rain_glass_pavilion_puddle_chrome.png" },
    @{ id = "desert_relic_gallery"; title = "Desert Relic Gallery"; scene = "desert_relic_gallery"; bookmark = "hero"; environment = "cool_overcast"; frames = 170; image = "desert_relic_gallery_hero.png" },
    @{ id = "desert_relic_gallery_stone_metal"; title = "Desert Stone and Metal"; scene = "desert_relic_gallery"; bookmark = "stone_metal_closeup"; environment = "cool_overcast"; frames = 150; image = "desert_relic_gallery_stone_metal.png" },
    @{ id = "desert_relic_gallery_arch_depth"; title = "Desert Arch Depth"; scene = "desert_relic_gallery"; bookmark = "arch_depth"; environment = "cool_overcast"; frames = 150; image = "desert_relic_gallery_arch_depth.png" },
