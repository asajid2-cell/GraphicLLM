...
Assert-NotContains "DepthPrepass.h" $depthHeader "std::function<void(const char*)> failStage"
...
Assert-NotContains "ShadowPass.h" $shadowHeader "std::function<void(const char*)> failStage"
