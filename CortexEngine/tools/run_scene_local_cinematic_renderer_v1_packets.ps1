...
$views = @(
    ...
    [pscustomobject]@{ Name = "reflection_background"; DebugView = 86 },
    [pscustomobject]@{ Name = "atmosphere"; DebugView = 87 },
    ...
    [pscustomobject]@{ Name = "reflection_source_suppression"; DebugView = 79 },
    ...
    [pscustomobject]@{ Name = "reflection_history_v3_rejection"; DebugView = 78 },
