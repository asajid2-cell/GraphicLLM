...
def compile_v3_to_v2(v3: dict[str, Any]) -> dict[str, Any]:
    ...
    env["graphics_pass"] = {
        ...
        "hero_asset_replacement": {
            ...
            "canvas_shell_panel_count": 1 if campsite else 0,
            "fabric_layer_count": 4 if campsite else 0,
            "structural_pole_count": 8 if campsite else 0,
            ...
            "systems": [
                "subdivided_canvas_shell_replaces_orange_tent_read",
                "mesh_owned_fabric_wrinkles_and_edge_hems",
                "structural_pole_frame_with_minimal_guyline_geometry",
                "panel_overlays_clamped_off_for_campsite",
